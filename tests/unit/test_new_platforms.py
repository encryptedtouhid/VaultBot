...
class TestSlackAdapter:
    ...
    def test_import_guard(self) -> None:
        ...
        from zenbot.platforms.slack import _SLACK_AVAILABLE
...
class TestTeamsAdapter:
    ...
    def test_import_guard(self) -> None:
        ...
        from zenbot.platforms.teams import _TEAMS_AVAILABLE
...
class TestIMessageAdapter:
    ...
    def test_import_succeeds(self) -> None:
        ...
        from zenbot.platforms.imessage import IMessageAdapter  # noqa: F401
