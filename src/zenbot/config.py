...
class ZenBotConfig(BaseSettings):
    """Main ZenBot configuration with secure defaults."""

    # General
    system_prompt: str = Field(
        default="You are ZenBot, a helpful and secure AI assistant. "
    ...
    @classmethod
    def load(cls, path: Path | None = None) -> ZenBotConfig:
