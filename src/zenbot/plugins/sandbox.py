...
from zenbot.plugins.base import PluginContext, PluginResult, PluginResultStatus
...
_RUNNER_SCRIPT = textwrap.dedent("""\
    ...
    for key in list(os.environ.keys()):
        if key.startswith(("ZENBOT_", "AWS_", "AZURE_", "GCP_", "DATABASE_")):
            del os.environ[key]
    ...
    async def main():
        ...
        try:
            ...
            from zenbot.plugins.base import PluginContext
