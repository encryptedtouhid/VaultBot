"""Main ZenBot orchestrator — ties platforms, LLM, security, and routing together."""
...
from zenbot.security.auth import AuthManager
...
if TYPE_CHECKING:
    ...
    from zenbot.llm.base import LLMProvider
    from zenbot.platforms.base import PlatformAdapter
...
class ZenBot:
    ...
    def __init__(self, config: ZenBotConfig) -> None:
        self._config = config
